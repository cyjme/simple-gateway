...
// wildcards (variables).
type Handle func(http.ResponseWriter, *http.Request, Params) string
...
func (r *Router) ClearRoute(method string) {
...
func (r *Router) Handle(method, path string, routeId string) {
	if path[0] != '/' {
...
func (r *Router) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	...
	if root := r.trees[req.Method]; root != nil {
		if handle, _, tsr := root.getValue(path); handle != "" {
			//handle(w, req, ps)
			return
